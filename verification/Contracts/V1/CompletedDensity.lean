...
/-! Proposition 4.6 in the exact three-field shape of
`research/R46/Spec.lean`, apart from the registry-conventional structure name. -/

noncomputable section

namespace BlowupDensity.Contracts.V1.CompletedDensity
...
structure CompletedDensityAPI where
...
end BlowupDensity.Contracts.V1.CompletedDensity
