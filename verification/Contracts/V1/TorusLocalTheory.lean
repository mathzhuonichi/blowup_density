...
/-! Periodic local theory and fixed-force H3 continuation interfaces, with mean
reduction and viscosity scaling. The H1-uniform restart is registered separately
by the version-two interface. -/
