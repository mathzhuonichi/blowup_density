...
/-! Corollary 4.5 for the compact and rapidly decaying force classes. The
four-field structure below is copied verbatim from `research/R45/Spec.lean`,
apart from the registry-conventional name. -/
noncomputable section

namespace BlowupDensity.Contracts.V1.ForceClasses
...
structure ForceClassesAPI where
...
end BlowupDensity.Contracts.V1.ForceClasses
