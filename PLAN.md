...
| 246-SPEC-r47-spec | 完成（sol，8 分钟）：Spec.lean 可 elaborate；mixedLebesgueENorm 1 2 ≠ forceSobolevENorm 1 0（载体不同，非定义等价）→ owner 决定拼写或注册零阶桥；PR 已开，链排在 #238 之后（wave 67） | 09-16 1513Z | #239 | — | SPEC **R47 定稿**：按 research/R47/RECONCILIATION.md 合并草案 A/B → Spec.lean + COMPARISON.md |
