...
| 189-A01-pressure-regularity | fix2 装配运行中（astra：194 的 G + 195/197 内点恒等式 + Helmholtz 逆向 ⇒ PressureSupply） | 09-16 0029Z | #— | — | A01 **P4 压力梯度正则性**：G = residual − ∂ₜu 在开板 [0,S)×R³ 上 C∞、逐时 L²（Leray 余项）、对称 Jacobian（余项是梯度）——180 的 `hpg`；输入 hc3/hsob/散度/169 的投影动量恒等式 |
