...
| 369-T17-U1-lattice-deriv | codex（astra）只交 k=0 形式；审稿 REJECT（缺一般 ∃k 形式与全局 ⨆ 推论）→ Opus 在 369 分支补全中 | 09-18 1221Z | — | — | T17 U1：格点提升的迭代导数桥（局部单拷贝 ⇒ iteratedFDeriv 相等；供 U5/U6 传输 eq:derivativebounds） |
