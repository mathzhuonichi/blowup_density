...
| 306-SPEC-t24-draft-a | sol 掉线（已有 924 行 DraftA）→ 05:45Z 续跑简报重启 | 09-18 0545Z | — | — | SPEC **T24 双盲草案 A**：`prop:affine`/`prop:multiple`/`prop:conservative`（三个独立结构；基于 T14/T15 定稿） |
