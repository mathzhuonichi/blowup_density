...
| 262-R45-contract-v1 | 基线同步 + 注册文件并集合并（37 个合同）后 PR 已开，合并链运行中（wave 86） | 09-16 1748Z | #258 | — | R45 **V1 合同注册**（第 33 个 R45.force_classes）：Spec 的 RClassesAPI 逐字；见证 = 257 的 guarded density/zeroIff + schwartzDensity + regularReference 由 254/257 Or.elim |
