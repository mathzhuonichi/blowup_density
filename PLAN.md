...
| 190-A01-b1-r4-joint-smooth | 进行中（codex sol xhigh） | 09-15 2149Z | #— | — | A01 **B1 R4 联合光滑代表元**：由 178 的全阶 C^j_t 数据路径造一个 u(t,x)，切片 a.e. 等于 U t 且在 [0,S)×R³ 上联合 C∞（Sobolev 嵌入 + 连续线性求值）——180 的 `hc3`；新增可满足性规则 |
