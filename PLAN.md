...
| 298-SPEC-t11-spec | 排队（并发上限 5；下一个空位启动；简报已写） | 09-17 2356Z | — | — | SPEC **T11 定稿**：按 research/T11/RECONCILIATION.md（`SolvesBelowT` 延拓假设、数据定义的 Galilean 均值、Poisson 压力、四个 API 结构 3+8+5+6+4 字段）→ Spec.lean + COMPARISON.md |
