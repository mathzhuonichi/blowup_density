...
| 154-C01-v3-bounds | 进行中 | 09-14 0852Z | — | — | C01 **V3 前置：energyDifferentialBound + l2Bound**（S–M）：由 V2 的 energyIdentity（HasDerivAt.unique + Cauchy–Schwarz + norm_toLp_sq_eq_l2Sq，136 审稿 finding 8）得 (‖u‖²)' ≤ 2‖u‖‖f‖（Spec.lean:364）；再由 Paper1.sqrt_energy_le_primitive 的推广得 eq:RL2 的 ‖u(t)‖₂ ≤ ‖a‖₂ + ∫₀ᵗ‖f‖₂（Spec.lean:383）；formalization 侧模块 + 记录，V3 合同下一条 lane |
| 其余节点 | 未开始 | — | — | — | |
