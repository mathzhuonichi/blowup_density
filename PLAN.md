...
| 258-R47-assembly | worktree 安装中→自动启动（codex astra low，带重试） | 09-16 1657Z | — | — | R47 **装配**：Spec 的 RGridAPI.choose——公共格子选球（247）+ 233 记录（球钉在该 cell）+ 251/253 观测相等 + 249 能量极限路线 + forceConvergence + 250 齐次界；唯一具名输入 CompactHomogeneousRealization（255 在闭合） |
