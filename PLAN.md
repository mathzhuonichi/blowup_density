...
| 352-T16-lattice-lift | codex 第 2 次 REJECT（接口假设需如实记为 358 义务；加最终→逐点转换引理；报告措辞）→ 同一 Opus 代理修复中 | 09-18 0949Z | — | — | T16 缺口 2：紧支修正的单位周期格点提升 latticeLift（局部有限、光滑、周期、支撑、无散、k=0 公式、eq:bgzero）→ 八个 correction_* 字段 |
