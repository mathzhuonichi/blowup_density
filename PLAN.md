...
| 358-T16-assembly | Opus 完成：`localPotential : localPotentialStatement` 全证（26 字段；Assembly.lean，含 352 修复接口；c60fd8bc）→ 排队 codex 审稿（astra 优先）；合入顺序 352 → 358 | 09-18 0952Z | — | — | T16 装配：`localPotential : localPotentialStatement`（347 截断/阈值 + 351 球上势 + 352 格点提升；卸载 correction_fields_of_chart 的 chart 级假设） |
