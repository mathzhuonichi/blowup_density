...
| 376-T15-U2-placement | codex（astra）REJECT → Opus 在 376 分支补全中（支撑链 + 紧性 + 真实 PlacementData probe） | 09-18 1319Z | — | — | T15 U2：缩放支撑放置（各切片支撑 ⊆ x₀ + ε•K_* ⊆ chart 球 ⊆ interior fundamentalCube；紧支撑）供 U3–U8 |
