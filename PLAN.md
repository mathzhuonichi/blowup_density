...
| 260-R47-contract-v1 | 审稿 ACCEPT-WITH-NOTES；注册文件与 #254 并集合并后 PR 已开，合并链运行中（wave 83）；第 34 个合同 | 09-16 1741Z | #255 | — | R47 **V1 合同注册**（第 35 个 R47.grid_observations）：Spec 的 RGridFamily/RGridAPI 逐字；见证 = rGrid_choose_of_realization 实例化 255 的 compactHomogeneousRealization |
| 261-R46-contract-v1 | 已合入 #254（wave 82 门禁 OK）；第 33 个合同 R46.completed_density V1 | 09-16 1741Z | #254 | — | R46 **V1 合同注册**（第 34 个 R46.completed_density）：Spec 的 REnergyAPI 逐字；见证 = 256 的 completedSobolevDensity + 259 的两条 _of_realization 实例化 255；L¹L² 项拼写差异记为 owner 问题 |
