...
| 250-I03-homogeneous-scaling | worktree 安装中→自动启动（codex astra low，带重试） | 09-16 1615Z | — | — | I03 **齐次负阶缩放**：Spec 里缺失的 packetNegativeHomogeneous / correctionNegativeHomogeneous（‖F_ε‖_{L^q_tḢ^s} ≤ Cε^β，抛物缩放的 Fourier 齐次权计算，以 IsHomogeneousPath 路径证 forceHomogeneousENorm 上界）——R46/R47 强闭包的 L²_tḢ⁻¹ 项所需 |
