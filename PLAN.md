...
| 350-SPEC-t24-spec | worktree 安装中→Opus prover 子代理 | 09-18 0822Z | — | — | SPEC **T24 定稿**（343 重做）：按 research/T24/RECONCILIATION.md（B 为基；prop:affine 全空间基于 I01.packet；prop:multiple Type 值、prop:conservative Prop；§2 修正强制）；反 stub 条款 |
