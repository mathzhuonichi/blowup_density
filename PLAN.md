...
| 369-T17-U1-lattice-deriv | codex 复审 REJECT（导出名应为 latticeLift_iteratedFDeriv_eq 给一般形式；报告开头过时；T17_SPLIT 的 U5/U6 状态）→ lead 采纳命名裁决，Opus 修复中 | 09-18 1256Z | — | — | T17 U1：格点提升的迭代导数桥（局部单拷贝 ⇒ iteratedFDeriv 相等；供 U5/U6 传输 eq:derivativebounds） |
