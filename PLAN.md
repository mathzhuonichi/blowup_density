...
| 345-T13-torus-identity | Opus 完成（torus_identity 全证）；sol 审稿 08:42Z 因 at capacity 死亡 → 改 astra 重审 | 09-18 0843Z | — | — | T13 证明：环面 Gagliardo 恒等式 `torus_identity`（Fourier 展开 + 周期化核展开为全空间积分 + 核缩放） |
