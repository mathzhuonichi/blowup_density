...
| 175-R43-s1-pairing | PR 已开，等 184（合并 main）落地后再走链 | 09-15 2046Z | #185 | — | R43 **S1 恒等式层**（HANDOFF P5）：临界路径 y² 的 datum 形定义、⟪Δu,Λu⟫ = −z²、⟪∇p,Λu⟫ = 0、⟪f,Λu⟫ ≤ by，装配成 henergy 形，只留 htri（三线性估计）与 hcrit（半阶齐次 datum 路径）两条具名假设 |
