...
| 352-T16-lattice-lift | codex REJECT（correction_cancels 接口假设整球抵消，论文只给包支撑邻域）→ 同一 Opus 代理修复中；358 已获通知 | 09-18 0919Z | — | — | T16 缺口 2：紧支修正的单位周期格点提升 latticeLift（局部有限、光滑、周期、支撑、无散、k=0 公式、eq:bgzero）→ 八个 correction_* 字段 |
