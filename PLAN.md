...
| 260-R47-contract-v1 | 已合入 #255（wave 83 门禁 OK）；第 34 个合同 R47.grid_observations V1 | 09-16 1743Z | #255 | — | R47 **V1 合同注册**（第 35 个 R47.grid_observations）：Spec 的 RGridFamily/RGridAPI 逐字；见证 = rGrid_choose_of_realization 实例化 255 的 compactHomogeneousRealization |
