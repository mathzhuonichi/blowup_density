...
| 214-R43-parseval | worktree 安装中→自动启动（codex astra low，带重试） | 09-16 0543Z | — | — | R43 **分数阶 Parseval**：pairing_identity（半阶数据配对 = 物理平流与 Λu 的 L² 配对，Plancherel + 191 的 |ξ|û 实现）⇒ CriticalAdvectionLpBridge 完整 ⇒ eq:Rcritical1 只条件于 CriticalDatumPath |
