...
| 347-T16-local-potential | Opus prover 子代理运行中（基座 = integration-section3 @338 合入后） | 09-18 0801Z | — | — | T16 证明：`lem:potential` localPotentialStatement（Urysohn 截断 θ/η、ε₀、径向向量势 ∇×A=v、修正 w_ε=−∇×(η_εθ_εA) 光滑无散周期、eq:bgzero）；复用 Section4/I02 Reference/Prescribed |
