...
| 234-R41D-small-gaps | 审稿 ACCEPT-WITH-NOTES（sol；两处记录修正：G5 早已在 235 的 Bindings 里、审计措辞，lead 已改）；PR 已开，合并链运行中（wave 76） | 09-16 1711Z | #248 | — | R41D **G2–G5**：F_rd ⊆ F_R、快速类在紧支撑校正下封闭、S_σ ⊆ X_R、‖0‖_{L^qH^s}=0（先核对是否已有，再证；不成立则写 COMPARISON_SMALL_GAPS 给 owner） |
