...
| 161-A01-b1-time-ladder | 合并中 | 09-15 1856Z | #172 | — | A01 **B1 时间正则阶梯 rung 1**（HANDOFF P8）：datum 路径的连续 selection（R1）+ 阶梯表 B1_LADDER.md；任务书 collaboration/briefs/161-*.md |
...
| 163-C01-e5-enstrophy | 合并中（排在 #172 后） | 09-15 1857Z | #173 | — | C01 **E5 enstrophy 导数**（HANDOFF P2 首环）：vendor wordEnergy_hasDerivWithinAt 在 s=1 减 s=0，分部积分得 −2⟪Δu,∂ₜu⟫，镜像 EnergyDerivative.lean |
