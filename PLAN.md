...
| 252-R45-compact-class | 审稿 ACCEPT（sol，无修改）；分支已并入集成分支；PR 已开，合并链排在 #244 之后（wave 73） | 09-16 1649Z | #245 | — | R45 **F_c 实例**：Spec 的 density/zeroIff 在 Y = forceClassCompact 下（235 的两情形模板 + forceDifference_compact 保持紧支撑；F_c ⊆ F_R 由 memForceR_insertedForce 取 g=0；非稠密由 breakdownSetIn F_c ⊆ breakdownSetRZero + 232/249 反证） |
