...
| 179-A01-gronwall-endpoint | 合并中（排在 #183 后） | 09-15 2024Z | #184 | — | A01 **行 (iii-b) Grönwall 端点**：把 149 的端点帽喂进 Grönwall 得整个 Ico 0 T 上不退化的显式界 + A04 restartBeyond 输入形状的一致 H¹ 界 |
