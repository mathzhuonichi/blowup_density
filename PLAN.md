...
| 118-SIMP-A04-nonlinear | PR 已开 | # | — | A04 SL5 簇五个模块（AdvectionDivergence, NonlinearPairing, NonlinearColumns, NonlinearDatum, NonlinearBound；100/102/105）的 simplifier+tester（陈述逐字不变；真负向检查；重跑 axioms_sl5*；MAINT 清单） |
