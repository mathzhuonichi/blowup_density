...
| 220-R44-s1c-trilinear | 审稿 ACCEPT（sol，无修改；符号翻转探针）；分支已并入集成分支；PR 已开，合并链运行中（wave 57） | 09-16 1353Z | #229 | — | R44 **S1c**：J 权三线性估计 abs⟪(u·∇)u,Ju⟫ ≤ C₀·Y·(Y²+Z²)（三因子 L³ Hölder + 165/182 临界嵌入 + 164 齐次≤非齐次 + 218 的 Jmul_norm/weight_identity）；静态逐切片；新增 AdvectionJDatum 不改 JWeightDatum |
