...
| 331-T11-U6-transport | sol 交付目标打包桩（transportInput = 三字段存在性）→ 作废；改派 Opus prover（简报加无输入条款） | 09-18 0553Z | — | — | T11 U6：解在光滑变量替换下的转运构造 → `transformed_solution`/`to_unit`/`from_unit`（L，sol） |
