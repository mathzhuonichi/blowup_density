...
| 100-A04-sl5a-divergence-form | PR 已开 | #102 | — | A04 SL5 行 5a（M）：无散场的对流项散度形式 `advection u t x = ∑ⱼ partialDeriv j (fun y => u (t,y) j • u (t,y)) x`（Leibniz + `spatialDivergence = 0`），`Section4/A04/AdvectionDivergence.lean` |
