...
| 252-R45-compact-class | worktree 安装中→自动启动（codex sol xhigh，带重试） | 09-16 1628Z | — | — | R45 **F_c 实例**：Spec 的 density/zeroIff 在 Y = forceClassCompact 下（235 的两情形模板 + forceDifference_compact 保持紧支撑；F_c ⊆ F_R 由 memForceR_insertedForce 取 g=0；非稠密由 breakdownSetIn F_c ⊆ breakdownSetRZero + 232/249 反证） |
