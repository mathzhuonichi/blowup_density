...
| 360-SPEC-t18-spec | Opus prover 子代理运行中（statement-only；基座含 T18 RECONCILIATION.md） | 09-18 0938Z | — | — | SPEC **T18 定稿**：按 research/T18/RECONCILIATION.md（B 为基；参数 PacketImportAPI/PlacementData/ScalingAPI/reference/CorrectionAPI；MemMixedLebesgueT 与 s<0 守卫；periodicSet 支撑；blowup_limsup）；反 stub 条款 |
