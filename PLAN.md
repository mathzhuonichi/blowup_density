...
| 381-T20-canonical | codex sol 完成：Section3/T20/CriticalRegularity.lean + probe + H1_CHECK.md（结论：T20 只需 H³ 窄化 API，H¹ 球非 T20 义务）→ 排队 codex 审稿 | 09-18 1310Z | — | — | T20 canonical 模块 Section3/T20/CriticalRegularity.lean（CriticalRegularityTAPI 逐字重述于 T10/T11/T12 规范模块之上）+ probe + H¹ 球核查 research/T20/H1_CHECK.md（对照 H1_GAP.md） |
...
| 383-T22-UB1-restrict-bridge | codex sol 完成：Domain.lean（T22 canonical 词汇）+ RestrictBridge.lean（restrictDatum_eq_restrictField、domainSobolevENorm_le_sobolevENorm），无缺口 → 排队 codex 审稿 | 09-18 1312Z | — | — | T22 U-B1：T22 canonical 词汇模块 Domain.lean + 限制桥 restrictDatum_eq_restrictField + 左侧不等式 domainSobolevENorm_le_sobolevENorm（zeroExtensionComparison 左分支） |
