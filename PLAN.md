...
| 352-T16-lattice-lift | Opus 完成：latticeLift（= vendor periodize，rfl）光滑/周期/无散/支撑/k=0 公式/取消 + correction_fields_of_chart（七字段投影接口，chart 级假设待装配卸载）→ 排队 codex 审稿（叠在 347 上） | 09-18 0908Z | — | — | T16 缺口 2：紧支修正的单位周期格点提升 latticeLift（局部有限、光滑、周期、支撑、无散、k=0 公式、eq:bgzero）→ 八个 correction_* 字段 |
