...
| 260-R47-contract-v1 | 审稿 ACCEPT-WITH-NOTES（sol；COMPARISON 过时段落已按审稿替换）；等 261（#254）落地后并集合并注册文件再开 PR | 09-16 1740Z | — | — | R47 **V1 合同注册**（第 35 个 R47.grid_observations）：Spec 的 RGridFamily/RGridAPI 逐字；见证 = rGrid_choose_of_realization 实例化 255 的 compactHomogeneousRealization |
