...
| 267-MAINT-archive-section4 | 已启动（codex astra low，带重试；无需 lean-install） | 09-16 2050Z | — | — | MAINT **归档第 4 节**（用户 2026-09-17 要求）：PLAN/NEXT_SESSION/HANDOFF/briefs≤262 → archive/section4/，新的 PLAN/NEXT_SESSION/HANDOFF 以第 3 节为主；台账用 tasks.py 把第 4 节节点标记完成；修链接；make check |
