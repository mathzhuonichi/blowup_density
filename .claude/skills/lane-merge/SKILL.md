...
3. `git push --force-with-lease origin <branch>`; poll `gh pr view N --json mergeable --jq .mergeable` until `MERGEABLE` (10–30 s after a force-push); `gh pr merge N --merge`.
