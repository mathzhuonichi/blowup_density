...
- **在跑（09-14 0417Z）**：无——router 429 限流窗口连杀三个 agent（143 审稿、144 审稿、145 worker）；等 10 分钟后逐个重启（先 145 worker，再 143/144 审稿），限流期间并发 2。已提交待审：143（C01 Ep/E3，E4 被 ∇p 时间正则性阻塞）、144（零解落地）。已合入（0200Z 后）：132–142、144；模块 114，合同 24。
