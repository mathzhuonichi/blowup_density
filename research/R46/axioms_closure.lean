...
#print axioms BlowupDensity.Bindings.closure_pairable
#print axioms BlowupDensity.Bindings.closure_path_sub
#print axioms BlowupDensity.Bindings.closure_path_add
#print axioms BlowupDensity.Bindings.closure_norm_eq
#print axioms BlowupDensity.Bindings.closure_norm_add
#print axioms BlowupDensity.Bindings.closure_homogeneousConvergence
#print axioms BlowupDensity.Bindings.strongTrajectoryClosure_of_realization
#print axioms BlowupDensity.Bindings.closure_relativeHomogeneous
...
example (hreal : I03.CompactHomogeneousRealization) :
    ∃ (P : PacketAPI 1) (A : InsertionFamilyAPI 1 P),
      ...
      (∀ ε ∈ Ioc (0 : ℝ) A.ε₀,
        MemForceR (A.force ε) ∧ maximalLifespanR 1 0 (A.force ε) = ENNReal.ofReal 1 ∧
