...
open scoped ENNReal
namespace NonDensityL2Conformance
...
#print axioms NSFormalization.Section4.R41.radius_le_forceSobolevENorm_L2
#print axioms NSFormalization.Section4.R41.nonDensityZero_L2
#print axioms NSFormalization.Section4.R41.zero_mem_forceClassR
#print axioms NSFormalization.Section4.R41.not_breakdownDenseR_zero_L2
...
#print axioms BreakdownDenseR_eq
 ...
 theorem nonDensityZero_L2 : ∀ ν T : ℝ, 0 < ν → 0 < T → ∀ s : ℝ, -1 / 2 ≤ s →
    ∃ ρ : ℝ, 0 < ρ ∧ ∀ f ∈ Data.breakdownSetRZero ν T,
      ENNReal.ofReal ρ ≤ Data.forceSobolevENorm 2 s f := by
  rw [← breakdownSetRZero_eq]
  exact R41.nonDensityZero_L2

 theorem not_breakdownDenseR_zero_L2 : ∀ ν T : ℝ, 0 < ν → 0 < T → ∀ s : ℝ,
    -1 / 2 ≤ s → ¬ Data.BreakdownDenseR ν (fun _ => 0) T 2 s := by
  rw [← BreakdownDenseR_eq]
  exact R41.not_breakdownDenseR_zero_L2

#print axioms nonDensityZero_L2
#print axioms not_breakdownDenseR_zero_L2

example : (0 : Data.SpaceTimeField) ∈ Data.forceClassR := R41.zero_mem_forceClassR
example : ¬ Data.BreakdownDenseR 1 (fun _ => 0) 1 2 (-1 / 2) :=
  not_breakdownDenseR_zero_L2 1 1 (by norm_num) (by norm_num) _ le_rfl
end NonDensityL2Conformance
