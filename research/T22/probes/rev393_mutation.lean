...
namespace NSFormalization.Section3.T22.Rev393
...
theorem orderZero (Ω : Set Space) (hΩ : IsOpen Ω) (z : SpatialField)
    (hz : ContDiffOn ℝ ∞ z Ω) :
    domainSobolevENorm Ω 0 (restrictField Ω z) = 2 * eLpNorm z 2 (volume.restrict Ω) := by
...
end NSFormalization.Section3.T22.Rev393
