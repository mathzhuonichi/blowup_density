...
example (hmild : TorusForcedMildOn C Ad P T u) (hPc : ContinuousOn P (Icc (0 : ℝ) T))
  ...
  exact torusPhysicalVelocity_hasDerivAt hmild hPc hu hF hPL hab
...
example (hmild : TorusForcedMildOn C Ad P T u) (hPc : ContinuousOn P (Icc (0 : ℝ) T))
    ...
    ∀ t ∈ Ioo (0 : ℝ) T, ∀ x : Space,
      NavierStokesR3.ProblemStatement.navierStokesResidual ν (torusPhysicalVelocity u) p t x =
        g (t, x) :=
  fun _ ht x ↦ momentum_of_pressure hmild hPc hu hF hPL hg hgp hFg hps hpp hpgrad hdivfree ht x
...
example (hmild : TorusForcedMildOn C Ad P T u) (hPc : ContinuousOn P (Icc (0 : ℝ) T))
  ...
  fun _ ht x ↦ momentum_of_mildPressure hmild hPc hu hF hPL hg hgp hFg hdivfree ht x
...
example (hmild : TorusForcedMildOn C Ad P T u) (hPc : ContinuousOn P (Icc (0 : ℝ) T))
  ...
  fun _ ht x ↦ projected_of_mildPressure hmild hPc hu hF hPL hg hgp hFg hdivfree ht x
