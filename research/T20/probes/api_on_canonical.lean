...
The T20 namespace below is the reconciled Spec namespace copied token-for-token
for its T20 definitions and `CriticalRegularityTAPI`; only canonical imports and
namespace resolution differ.  The bridges at the end are definitional or
fieldwise structure conversions.  No API inhabitant is constructed.
-/
...
/-! Existential statement form; no API inhabitant is constructed. -/
...
theorem meanPathT_eq :
    @BlowupDensity.T20.Spec.meanPathT = @NSFormalization.Section3.T20.meanPathT := rfl

theorem meanFreeVelocity_eq :
    @BlowupDensity.T20.Spec.meanFreeVelocity =
      @NSFormalization.Section3.T20.meanFreeVelocity := rfl

theorem meanFreeForce_eq :
    @BlowupDensity.T20.Spec.meanFreeForce =
      @NSFormalization.Section3.T20.meanFreeForce := rfl

theorem constantTransportT_eq :
    @BlowupDensity.T20.Spec.constantTransportT =
      @NSFormalization.Section3.T20.constantTransportT := rfl

theorem constantTransportSpatialT_eq :
    @BlowupDensity.T20.Spec.constantTransportSpatialT =
      @NSFormalization.Section3.T20.constantTransportSpatialT := rfl

theorem meanForceIntegralT_eq :
    @BlowupDensity.T20.Spec.meanForceIntegralT =
      @NSFormalization.Section3.T20.meanForceIntegralT := rfl

theorem criticalY_eq :
    @BlowupDensity.T20.Spec.criticalY =
      @NSFormalization.Section3.T20.criticalY := rfl

theorem criticalZ_eq :
    @BlowupDensity.T20.Spec.criticalZ =
      @NSFormalization.Section3.T20.criticalZ := rfl

theorem criticalB_eq :
    @BlowupDensity.T20.Spec.criticalB =
      @NSFormalization.Section3.T20.criticalB := rfl

theorem criticalBIntegral_eq :
    @BlowupDensity.T20.Spec.criticalBIntegral =
      @NSFormalization.Section3.T20.criticalBIntegral := rfl

theorem criticalRho_eq :
    @BlowupDensity.T20.Spec.criticalRho =
      @NSFormalization.Section3.T20.criticalRho := rfl

theorem gradientSqT_eq :
    @BlowupDensity.T20.Spec.gradientSqT =
      @NSFormalization.Section3.T20.gradientSqT := rfl

theorem laplacianSqT_eq :
    @BlowupDensity.T20.Spec.laplacianSqT =
      @NSFormalization.Section3.T20.laplacianSqT := rfl

theorem lTwoSqT_eq :
    @BlowupDensity.T20.Spec.lTwoSqT =
      @NSFormalization.Section3.T20.lTwoSqT := rfl

theorem meanFreeForceLTwoSqIntegral_eq :
    @BlowupDensity.T20.Spec.meanFreeForceLTwoSqIntegral =
      @NSFormalization.Section3.T20.meanFreeForceLTwoSqIntegral := rfl

theorem meanModeCriterionIntegral_eq :
    @BlowupDensity.T20.Spec.meanModeCriterionIntegral =
      @NSFormalization.Section3.T20.meanModeCriterionIntegral := rfl

theorem periodicPairing_eq :
    @BlowupDensity.T20.Spec.periodicPairing =
      @NSFormalization.Section3.T20.periodicPairing := rfl

def toModuleAPI (h : BlowupDensity.T20.Spec.CriticalRegularityTAPI) :
  ...
  { c := h.c
    ...
    CH1 := h.CH1
    CH1_pos := h.CH1_pos
    Ccriterion := h.Ccriterion
    hCcriterion := h.hCcriterion
    c_lt_C₀ := h.c_lt_C₀
    c_lt_C₁ := h.c_lt_C₁
    reductionRegular := h.reductionRegular
    meanBound := h.meanBound
    meanFreeEquation := h.meanFreeEquation
    constantTransportSkew := h.constantTransportSkew
    constantTransportCommutesLambda := h.constantTransportCommutesLambda
    criticalEnergy := h.criticalEnergy
    bIntegral := h.bIntegral
    yBound := h.yBound
    hOneEnergy := h.hOneEnergy
    continuationBound := h.continuationBound
    globalRegularity := h.globalRegularity }

def ofModuleAPI (h : NSFormalization.Section3.T20.CriticalRegularityTAPI) :
    BlowupDensity.T20.Spec.CriticalRegularityTAPI :=
  { c := h.c
    hc := h.hc
    C₀ := h.C₀
    C₀_pos := h.C₀_pos
...
theorem ofModuleAPI_toModuleAPI
    (h : BlowupDensity.T20.Spec.CriticalRegularityTAPI) :
    ofModuleAPI (toModuleAPI h) = h := rfl

theorem toModuleAPI_ofModuleAPI
    (h : NSFormalization.Section3.T20.CriticalRegularityTAPI) :
    toModuleAPI (ofModuleAPI h) = h := rfl

theorem criticalRegularityStatement_eq :
    BlowupDensity.T20.Spec.criticalRegularityStatement =
      NSFormalization.Section3.T20.criticalRegularityStatement := by
  apply propext
  constructor
  · rintro ⟨h⟩
    exact ⟨toModuleAPI h⟩
...
#print axioms T20Probe.meanPathT_eq
#print axioms T20Probe.meanFreeVelocity_eq
#print axioms T20Probe.meanFreeForce_eq
#print axioms T20Probe.constantTransportT_eq
#print axioms T20Probe.constantTransportSpatialT_eq
#print axioms T20Probe.meanForceIntegralT_eq
#print axioms T20Probe.criticalY_eq
#print axioms T20Probe.criticalZ_eq
#print axioms T20Probe.criticalB_eq
#print axioms T20Probe.criticalBIntegral_eq
#print axioms T20Probe.criticalRho_eq
#print axioms T20Probe.gradientSqT_eq
#print axioms T20Probe.laplacianSqT_eq
#print axioms T20Probe.lTwoSqT_eq
#print axioms T20Probe.meanFreeForceLTwoSqIntegral_eq
#print axioms T20Probe.meanModeCriterionIntegral_eq
#print axioms T20Probe.periodicPairing_eq
#print axioms T20Probe.toModuleAPI
#print axioms T20Probe.ofModuleAPI
#print axioms T20Probe.ofModuleAPI_toModuleAPI
#print axioms T20Probe.toModuleAPI_ofModuleAPI
#print axioms T20Probe.criticalRegularityStatement_eq
