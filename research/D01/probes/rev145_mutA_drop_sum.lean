-- REVIEW PROBE (lane 145, mutation A): norm_raise_le with the ∑ⱼ‖C j‖² term DROPPED.
-- Expected: the proof of norm_raise_le fails.  Read-only copy; not part of the build.
