...
example : ∀ ε ∈ Ioc (0 : ℝ) ε₀, ∀ t, ∀ x ∈ ball x₀ r,
  ...
  (correction_fields_of_chart v U x₀ θ η A r T ε₀ θRadius W hr2 hv_per
    hεspace hWsmooth hWcompact hWdiv hWtsupp hWformula hWcancel).1

/-- `correction_smooth` (verbatim). -/
example : ∀ ε ∈ Ioc (0 : ℝ) ε₀, ContDiff ℝ ∞ (latticeLift (W ε)) :=
  (correction_fields_of_chart v U x₀ θ η A r T ε₀ θRadius W hr2 hv_per
    hεspace hWsmooth hWcompact hWdiv hWtsupp hWformula hWcancel).2.1

/-- `correction_periodic` (verbatim). -/
example : ∀ ε ∈ Ioc (0 : ℝ) ε₀, IsPeriodicOn univ (latticeLift (W ε)) :=
  (correction_fields_of_chart v U x₀ θ η A r T ε₀ θRadius W hr2 hv_per
    hεspace hWsmooth hWcompact hWdiv hWtsupp hWformula hWcancel).2.2.1

/-- `correction_divergence_free` (verbatim). -/
example : ∀ ε ∈ Ioc (0 : ℝ) ε₀, ∀ t x,
    spatialDivergence (latticeLift (W ε)) t x = 0 :=
  (correction_fields_of_chart v U x₀ θ η A r T ε₀ θRadius W hr2 hv_per
    hεspace hWsmooth hWcompact hWdiv hWtsupp hWformula hWcancel).2.2.2.1
...
example : ∀ ε ∈ Ioc (0 : ℝ) ε₀,
  ...
  (correction_fields_of_chart v U x₀ θ η A r T ε₀ θRadius W hr2 hv_per
    hεspace hWsmooth hWcompact hWdiv hWtsupp hWformula hWcancel).2.2.2.2.1

/-- `correction_support_ball` (verbatim). -/
example : ∀ ε ∈ Ioc (0 : ℝ) ε₀, ∀ t,
    tsupport (fun x => latticeLift (W ε) (t, x)) ⊆ periodicSet (ball x₀ r) :=
  (correction_fields_of_chart v U x₀ θ η A r T ε₀ θRadius W hr2 hv_per
    hεspace hWsmooth hWcompact hWdiv hWtsupp hWformula hWcancel).2.2.2.2.2.1
...
example : ∀ ε ∈ Ioc (0 : ℝ) ε₀, ∀ t ∈ Ico (T - ε ^ 2) T,
  ...
  (correction_fields_of_chart v U x₀ θ η A r T ε₀ θRadius W hr2 hv_per
    hεspace hWsmooth hWcompact hWdiv hWtsupp hWformula hWcancel).2.2.2.2.2.2
