...
| A3-M2 · envelope | everywhere-interior differentiable squared-energy majorant | signed limit and scalar comparison | CONDITIONAL, lane 199 | `MildEnergyEnvelope.lean` | Exact regularized full-word dissipative identity and explicit scalar ODE envelope proved. One named `CylinderRootComparison` remains for the conditional finite-energy/conversion/base-family chain. No unconditional closure or general-data A. See `REPORT_199.md`. |
