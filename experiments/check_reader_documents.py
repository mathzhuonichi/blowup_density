#!/usr/bin/env python3
"""Check reader-document correspondence, not PDF layout or mathematical correctness."""
import json
import hashlib
import re
...
def main():
    ...
    assert r'\section{Formalized scope and proof methods}' in guide
    ...
    assert set(status.values()) == {'Closed'}
    ...
    print('Both checked-in PDFs are present. Scope: structural checks, not layout QA or a new proof certification.')
