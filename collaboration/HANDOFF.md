...
| P10/P11 R41、R41D、SPEC | **Theorem 4.1（Y = F_R）注册为第 32 个合同 `R41.main_thresholds` V1（249，审稿中）**：232/233/235 全部合入；规范 R41/R45/R46/R47 定稿并合入（#240/#238/#237/#239） | **可领**：R45 cor:Rclasses 证明（等 234 的 G2–G4）；R46/R47 装配（等 250 的 I03 齐次界、247 网格引理） |
