...
| P10/P11 R41、R41D、SPEC | **Theorem 4.1（Y = F_R）= 第 32 个合同 `R41.main_thresholds` V1，已合入 #242**：232/233/235 全部合入；规范 R41/R45/R46/R47 定稿并合入（#240/#238/#237/#239） | 进行中：R45 F_c 实例（252 合入、254 审稿）；R47 eq:gridforce 闭合（247/251 合入、253 链中）；I03 齐次缩放（250 合入、255 在做）；R46 第一字段（256） | **可领**：R45 快速类/Schwartz 实例（等 234）；R46/R47 装配（等 255） |
