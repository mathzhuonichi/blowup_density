...
article proof logic and the exact scope of every Closed result.
...
[guide](../../paper/formalization_guide.pdf) explains coverage labels.
...
The guide records 27 Closed entries. The statement-level
[input-closure audit](CLOSURE_AUDIT.md) identifies the compiled suppliers for
the six entries closed in the final phase.
