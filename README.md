...
The article-level inventory contains **27 Closed and 0 Partial entries**.
...
All 27 mapped article entries are Closed. Broader variants outside the mapped
article statements may remain out of scope as documented in the guide.
