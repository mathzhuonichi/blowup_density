...
\mapped{Lemma}{lem:correction} & \coverage{Partial}\source{F/Section3/T17/Assembly}{107}{correctionStatementAmended_holds}{theorem}.
The formal statement includes explicit smoothness, chart and positive-viscosity
hypotheses. These are supplied in the downstream gluing theorem. \\
\mapped{Theorem}{thm:insertion} & \coverage{Partial}\source{F/Section3/T18/Assembly}{238}{periodicInsertionStatement_holds}{theorem};
\source{F/Section3/T19/Threading}{126}{insertion}{def}.
The generic assembly takes scaling and correction records. The construction
from raw data uses a fixed ball; the prescribed-ball version is not yet closed. \\
...
\mapped{Remark}{rem:peaks} & \coverage{Partial}No separately registered conclusion for divergence
of the force amplitudes. Related estimates: \source{F/Section3/T15/Assembly}{130}{scalingStatement_holds}{theorem}
and \source{F/Section3/T17/Assembly}{107}{correctionStatementAmended_holds}{theorem}. \\
