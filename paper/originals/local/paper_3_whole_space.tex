...
\end{align}
\end{theorem}
% Citation audit (11 September 2026): the displayed pressure-bearing forced
% packet, including the L^\infty blow-up conclusion, is cited to OpenAI
% Theorem 1.1. Tao Theorem 38 gives H^s blow-up for a different, unforced
% mean-zero periodic problem and is not used for this conclusion.
